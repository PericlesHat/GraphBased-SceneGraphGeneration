...
"""
A Triple GCN implemented from wffancy & SGPN of Wald et al.
Triple GCN shows great performance in scene graph classification tasks.
"""
...
class GraphTripleConv(nn.Module):
    ...
    def forward(self, obj_vecs, pred_vecs, edges):
        ...
        # O: nums of objects    T: nums of predicates
        ...
        # overcome Laplacian smoothing, need to make hidden_dim == input_dim
        new_obj_vecs = obj_vecs + new_obj_vecs
